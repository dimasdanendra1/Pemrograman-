...
class FormPerawat:
    ...
    def aturKomponen(self):
        ...
        Label
        Label(mainFrame, text='Nama Pemesan:').grid(row=0, column=0, sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text='Makanan:').grid(row=1, column=0, sticky=W, padx=5, pady=5)
        self.txtNama = Entry(mainFrame) 
        self.txtNama.grid(row=1, column=1, padx=5, pady=5) 

        Label(mainFrame, text='Minuman:').grid(row=2, column=0, sticky=W, padx=5, pady=5)
        ...
        # define columns
        columns = ('id', 'nama', 'makanan','minuman')
